...
import InterfaceParts.PortEnviarJogadaLogicNGProxyOutbox;
import InterfaceParts.PortLogicGUIOutbox;
...
public class HeroQuest {
	...
	protected PortLogicGUIOutbox atorJogador;
	protected PortEnviarJogadaLogicNGProxyOutbox NGproxy;
	...
	public HeroQuest(PortOutbox gui, PortOutbox proxy) {
		this.players = new ArrayList<Player>();
		//this.atorJogador = ator;
		atorJogador = (PortLogicGUIOutbox) gui;
		NGproxy = (PortEnviarJogadaLogicNGProxyOutbox) proxy;
		
		//this.setAtorClienteServidor(new AtorClientServer(this));
	...
	public void setAtorClienteServidor(AtorClientServer atorClienteServidor) {
		this.atorClienteServidor = atorClienteServidor;
	}
}
